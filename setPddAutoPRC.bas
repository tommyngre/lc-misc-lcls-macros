Attribute VB_Name = "setPddAutoPRC"
Sub setPddAutoPRC()
...
'    TCodeDelimiter = InputBox("Enter delimiter for string of test codes." & vbNewLine & vbNewLine & "If null, comma delimiter is assumed.", "Lab Code")
'    If (TCodeDelimiter = "") Then
        Dim TCodeDelimiter As String
        TCodeDelimiter = ","
'    End If
'    '</OPTION>
